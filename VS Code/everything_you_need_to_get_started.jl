...
matwrite("data/data.mat", Dict("A" => rand(10, 10), "a" => randn(20)); version="v7.3") #(version specifies MATLAB version)
...
data2 = JSON.parsefile("data/data.json")
data2 == data
